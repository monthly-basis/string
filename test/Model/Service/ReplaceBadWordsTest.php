...
class ReplaceBadWordsTest extends TestCase
{
    ...
    public function testReplaceBadWords()
    {
        ...
        $string = 'fu*king Confucius John F. Kennedy Fuecking of office';
        $this->assertSame(
            "$r Confucius John F. Kennedy {$r}ing of office",
            $this->replaceBadWordsService->replaceBadWords($string)
        );
        ...
        $string = ' nigleT nig night nicker nggas Nick Gurr';
        $this->assertSame(
            " $r $r night $r {$r}s $r",
            $this->replaceBadWordsService->replaceBadWords($string)
        );
