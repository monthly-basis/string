...
class ToHtmlTest extends TestCase
{
    ...
    public function test_toHtml_externalDomain_aHrefWithAttributes()
    {
        ...
        $this->escapeServiceMock
            ...
            ->willReturn($url);
        $this->assertSame(
            '<a href="https://www.yahoo.com" rel="noopener ugc">https://www.yahoo.com</a>',
            $this->toHtmlService->toHtml($url)
        );
    }
    ...
    public function test_toHtml_googleDomainUrl1_simplifiedAHref()
    {
        ...
        $this->escapeServiceMock
            ...
            ->willReturn($url);
        $this->assertSame(
            '<a href="https://www.google.com/search?q=how+to+write+a+good+thesis+sentence" rel="noopener ugc">https://www.google.com/search?q=how+to+write+a+good+thesis+sentence</a>',
            $this->toHtmlService->toHtml($url)
        );
    }
    ...
    public function test_toHtml_googleDomainUrl2_simplifiedAHref()
    {
        ...
        $this->escapeServiceMock
            ...
            ->willReturn($url);
        $this->assertSame(
            '<a href="https://www.google.com/search?q=outcome+of+the+1914+Battle+of+Tannenberg" rel="noopener ugc">https://www.google.com/search?q=outcome+of+the+1914+Battle+of+Tannenberg</a>',
            $this->toHtmlService->toHtml($url)
        );
    }
}
